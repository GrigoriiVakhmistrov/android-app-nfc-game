...
public class Message {
    ...
    public static final String BRACER_ALREADY_EXIST = "Браслет уже зарегистрирован";
    public static final String FIELDS_NOT_FILLED = "Не все поля заполнены";
    public static final String USER_THIS_BRACER_NOT_FOUND = "Пользователь с таким браслетом не зарегистрирован";
